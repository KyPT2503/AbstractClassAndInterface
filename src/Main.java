...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(materialManager.materials[5].getRealMoney());
        System.out.println(materialManager.materials[5].getAmount());
        System.out.println(materialManager.materials[5].calPriceDifferent());
    }
}
